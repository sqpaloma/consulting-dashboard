...
const DashboardCalendar = dynamic(
  () =>
    import("@/components/dashboard/dashboard-calendar").then(
      (m) => m.DashboardCalendar
    ),
  {
    ssr: false,
    loading: () => (
...
const DistributionPanel = dynamic(
  () =>
    import("@/components/dashboard/distribution-panel").then(
      (m) => m.DistributionPanel
    ),
  {
    ssr: false,
    loading: () => (
...
const ActivityPlanner = dynamic(
  () =>
    import("@/components/dashboard/activity-planner").then(
      (m) => m.ActivityPlanner
    ),
  {
    ssr: false,
...
const DashboardModal = dynamic(
  () =>
    import("@/components/dashboard/dashboard-modal").then(
      (m) => m.DashboardModal
    ),
  {
    ssr: false,
...
const ResponsavelFilter = dynamic(
  () =>
    import("@/components/dashboard/responsavel-filter").then(
      (m) => m.ResponsavelFilter
    ),
  { ssr: false }
);
